...
const WhatsAppIcon = ({ className = "h-8 w-8 text-black" }: { className?: string }) => (
...
export const WhatsAppButton: React.FC = () => {
    const phoneNumber = "5575982199009";
    const message = encodeURIComponent("Olá! Gostaria de ajuda com os perfumes.");
    ...
    return (
        <a
            ...
            className="fixed bottom-6 right-6 z-50 rounded-full h-16 w-16 flex items-center justify-center transition-all duration-300 shadow-lg shrink-0 bg-brand-gold hover:bg-yellow-400 shadow-gold-glow animate-fade-in"
        >
